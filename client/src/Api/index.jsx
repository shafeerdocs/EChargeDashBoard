...
export const editStationById = async (stationId, station) =>
  await axios.put(`${stationUrl}/${stationId}`, station);
...
export const editSocketById = async (socketId, socket) =>
  await axios.put(`${socketUrl}/${socketId}`, socket);
